...
export class Addon {
     ...
     * tank's body. 
     */
    protected createAutoTurrets(count: number, customDefinition: BarrelDefinition | null=null ) {
        ...
        for (let i = 0; i < count; ++i) {
            const turretDefinition = customDefinition || AutoTurretMiniDefinition;
            const base = new AutoTurret(rotator, turretDefinition);
    ...
    public constructor(owner: BarrelBase) {
        ...
        this.createAutoTurrets(4, {
            ...
            bullet: {
                ...
                lifeLength: 1,
                sizeRatio: 1,
                absorbtionFactor: 1, // Corrected spelling if needed
            },
        });
    }
}
