...
export default class ObjectEntity extends Entity {
    ...
    /** collisions*/
    public collidedWithObject=false
    ...
    protected findCollisions() {
        ...
        this.collidedWithObject = false;  // Initialize the collision status for this tick
            ...
            if (entity.physicsData.values.sides === 2 && this.physicsData.values.sides === 2) {
                ...
                */
                ...
                if (dX ** 2 + dY ** 2 <= this.physicsData.size ** 2) {
                    ...
                    this.collidedWithObject = true;  // Collision detected with this entity
                }
            } else if (this.physicsData.values.sides === 2 && entity.physicsData.values.sides !== 2) {
